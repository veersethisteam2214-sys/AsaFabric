...
// This is a React + Next.js + framer-motion component (from 21st.dev).
// The Asa Fabric site is VANILLA HTML/CSS/JS (no build, no React).
// Use this file to understand the TARGET LOOK + BEHAVIOR, then re-create
// it in vanilla JS inside app.js (the existing #worldMapStage injector).
// See design-references/README.md for what to port and what to ignore.
// ============================================================================
