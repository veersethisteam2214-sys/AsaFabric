  ...
  return (  
    \<div className="w-full aspect-\[2/1\] md:aspect-\[2.5/1\] lg:aspect-\[2/1\] dark:bg-black bg-white rounded-lg relative font-sans overflow-hidden"\>  
      \<Image  
        ...
        className="h-full w-full \[mask-image:linear-gradient(to\_bottom,transparent,white\_10%,white\_90%,transparent)\] pointer-events-none select-none object-cover"  
        alt="world map"  
        height="495"  
        width="1056"  
        draggable={false}  
